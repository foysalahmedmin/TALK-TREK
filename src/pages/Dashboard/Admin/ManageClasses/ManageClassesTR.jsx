        ...
        <tr data-aos="zoom-in">
            ...
            <th >
                <div className="text-center h-full flex justify-center items-center flex-wrap gap-1">
                    <button onClick={()=> statusHandler('approved')} disabled={status == 'approved' || status == 'denied'} className="secondary-btn-sm">Approved</button>
                    <button onClick={()=> statusHandler('denied')} disabled={status == 'approved' || status == 'denied' } className="secondary-btn-sm">Denied</button>
                </div>
            </th>
