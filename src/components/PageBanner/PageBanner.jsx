...
const PageBanner = ({ title, summary }) => {
    return (
        <section className={`bg-[url('/bg.png')] bg-top bg-no-repeat`}>
            <div className='bg-base-100 bg-opacity-75 min-h-[30rem] flex w-full justify-center items-center pt-20'>
                <div className="container">
                    <div className="text-center px-5 py-10 bg-base-100 bg-opacity-50 shadow-xl">
